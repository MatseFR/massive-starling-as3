package 
{
	...
	public class MassiveDemo extends Sprite 
	{
		...
		private function assetsLoaded():void
		{
			...
			var btn:Button = null;
			var btnHeight:Number = quad.height;
			var tf:TextField;
			var gap:Number = 2;
			var tX:Number;
			var tY:Number = 0;
			...
			for (i = 0; i < this.scales.length; i++)
			{
				...
				btn = new Button(this.displayScale == scaleFactor ? this.miniButtonTextureON : this.miniButtonTextureOFF, scaleFactor.toString(), null, this.miniButtonTextureON);
				btn.x = tX;
